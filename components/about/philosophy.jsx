            ...
            <div className="sec_title_static">
              <div className="sec_title_wrap">
                <div className="title-area">
                  <h2 className="sec-title">Our <br /> Philosophy</h2>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="feature-static-wrap">
                ...
                <div className="feature-card style-grid">
                  ...
                  <div className="feature-card-details">
                    <h4 className="feature-card-title">
                      <a href="#">Collaboration as the Cornerstone</a>
                    </h4>
              ...
              <div className="feature-static">
                <div className="feature-card style-grid">
                  ...
                  <div className="feature-card-details">
                    <h4 className="feature-card-title">
                      <a href="#">Adaptability and Agility</a>
                    </h4>
                    <p className="feature-card-text">
              ...
              <div className="feature-static">
                <div className="feature-card style-grid">
                  ...
                  <div className="feature-card-details">
                    <h4 className="feature-card-title">
                      <a href="#">Beyond Technical Excellence</a>
                    </h4>
                    <p className="feature-card-text">
              ...
              <div className="feature-static">
                <div className="feature-card style-grid">
                  ...
                  <div className="feature-card-details">
                    <h4 className="feature-card-title">
                      <a href="#">A Culture of Excellence</a>
                    </h4>
                    <p className="feature-card-text">

export const menuItems = [
  ...
  },
  {
    ...
    title: "SECTORS",
    subMenuItems: [
      { id: 71, label: "Commercial", link: "/commercial" },
      { id: 72, label: "Education", link: "/education" },
      { id: 73, label: "Government", link: "/government" },
      { id: 74, label: "Healthcare", link: "/healthcare" },
      { id: 75, label: "Hospitality", link: "/hospitality" },
      { id: 76, label: "Industrial", link: "/industrial" },
      { id: 77, label: "Oil and Gas", link: "/oil-and-gas" },
      { id: 78, label: "Power and Energy", link: "/power-and-energy" },
      { id: 79, label: "Railways", link: "/railways" },
      { id: 710, label: "Religious", link: "/religious" },
      { id: 711, label: "Residential and Villa", link: "/residential-and-villa" },
      { id: 712, label: "Roads and Infrastructure", link: "/roads-and-infrastructure" },
      { id: 713, label: "Shelters", link: "/shelters" },
      { id: 714, label: "Tank Farms", link: "/tank-farms" },
    ],    
  },
  // {
  //   id: 3,
  ...
  // },
  {
    ...
    //       { id: 224, label: "Service Details Page", link: "/service-details/2" },
    //     ],
    //   },
    ...
    //   { id: 28, label: "Privacy Policy", link: "/privacy-policy" },
    //   { id: 29, label: "Terms of Use", link: "/Termsofuse" },
    //   { id: 210, label: "Newsroom", link: "/newsroom" },
    // ],
  },
